      ...
      <div className="min-h-screen px-24 pt-15 bg-[#FAF9F6]">
        ...
        <div className="px-8 pt-14 pb-4 flex justify-between items-center ">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-md font-bold text-slate-800">Rahul Sharma</h2>
        ...
        <div className="px-6 mt-8 space-y-4">
          <div className="flex justify-between items-center">
            ...
            <span className="text-xs font-bold text-orange-500 px-3 py-1 bg-orange-50 rounded-full">3 Orders</span>
          </div>
          ...
          <AnimatePresence>
            {!isOnDuty ? (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="bg-slate-50 border-2 border-dashed border-slate-200 rounded-3xl p-10 text-center"
              >
                ...
                <div className="bg-white p-5 rounded-[2rem] shadow-sm border border-slate-100">
                  <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-black text-slate-800">EST. EARNING: ₹55</span>
                    </div>
